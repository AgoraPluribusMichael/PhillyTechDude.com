$(document).ready(function() {
    ...
    $("#article").append(
        ...
        '<footer style="padding-top:0">'+
            ...
            '<p>I never formally studied law, public policy, or political science; I\'m just a guy who lives here, and I\'m fed up waiting for the next big establishment Democratic politician to save us from Trump while the whole world devolves into madness.</p>'+
            '<p style="text-align:center">&copy; 2025 Philly Tech Dude. All rights reserved.</p>'+
        '</footer>'
    );
});